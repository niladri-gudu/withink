...
export async function safeDecryptText(encryptedData: string, key: CryptoKey | null): Promise<string> {
  if (!key || !encryptedData || typeof encryptedData !== "string" || !encryptedData.includes(":")) {
    return encryptedData;
  }
  try {
