...
export class ValidationError extends AppError {
  ...
  constructor(
    message: string,
    safeMessage: string = "Validation failed. Please check your inputs.",
  ) {
...
export class AuthenticationError extends AppError {
  ...
  constructor(
    message: string,
    safeMessage: string = "You must be authenticated to perform this action.",
  ) {
    super(message, safeMessage);
  }
}
...
export class AuthorizationError extends AppError {
  ...
  constructor(
    message: string,
    safeMessage: string = "You do not have permission to access this resource.",
  ) {
    super(message, safeMessage);
  }
}
...
export class InfrastructureError extends AppError {
  ...
  constructor(
    message: string,
    safeMessage: string = "An error occurred with our systems. Please try again later.",
  ) {
    super(message, safeMessage);
  }
}
...
export class UnexpectedError extends AppError {
  ...
  constructor(
    message: string,
    safeMessage: string = "An unexpected error occurred. Please try again later.",
  ) {
    super(message, safeMessage);
  }
}
