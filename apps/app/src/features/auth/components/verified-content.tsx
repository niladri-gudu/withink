  ...
  return (
    <div className="bg-card border-border/80 animate-in fade-in mx-auto w-full max-w-md space-y-6 rounded-xl border p-6 shadow-md duration-300 select-none sm:space-y-8 sm:p-8">
      <div className="space-y-1.5 text-center sm:text-left">
        ...
        <p className="text-caption font-mono tracking-[0.2em] uppercase">
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="text-center">
          <Link
            ...
            className="text-muted-foreground/60 hover:text-foreground border-muted-foreground/20 hover:border-foreground inline-block border-b pb-0.5 font-mono text-xs tracking-widest uppercase transition-all"
          >
            Return Home
          </Link>
        </div>
