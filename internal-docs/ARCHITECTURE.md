...
- withink.me (Root Domain): Serves the static marketing landing page, Contact Us, Privacy Policy, and Terms & Conditions. Managed inside the /docs repository scope.
- app.withink.me (App Subdomain): Houses the secure, authenticated sanctuary journal dashboard, editor, media gallery, insights, and settings. Managed inside the /app repository scope.
