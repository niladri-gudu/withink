        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div className="flex flex-col items-start">
              ...
              <span className={cn("text-[10px] opacity-60", selectedDate === null ? "text-background/80" : "text-muted-foreground")}>
          ...
          >
            <div className="flex items-center justify-between w-full gap-2">
              <div className="flex flex-col gap-0.5">
                ...
                <p className={cn("text-[11px] opacity-70", selectedDate === today ? "text-primary-foreground/80" : "text-muted-foreground")}>
                  {hasTodayEntry ? "Continue reflecting" : "Capture your thoughts"}
                </p>
              </div>
              <div className={cn(
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className={cn("text-[10px] truncate mt-1 leading-none opacity-60", isSelected ? "text-background/70" : "text-muted-foreground")}>
                            {entry.wordCount} words • {entry.preview || "No content"}
                          </p>
                        </div>
                      </Button>
                    );
